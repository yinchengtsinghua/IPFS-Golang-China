...
//p2pprotoprefix是协议名称的默认必需前缀
const P2PProtoPrefix = "/x/"

//p2plistenerInfo输出是ls命令的输出类型
...
//p2pstreaminfooutput是streams命令的输出类型
...
//parseIPfsAddr是一个接受addr字符串并返回ipfsAddr的函数
...
//checkport检查目标multiaddr是否包含TCP或UDP协议
//端口是否等于0
func checkPort(target ma.Multiaddr) error {
//从multiaddr获取TCP或UDP端口
...
//p2pstreamcd是'ipfs p2p stream'命令
