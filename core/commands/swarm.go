...
//parseAddresses是一个函数，它接受一段字符串对等地址。
//（multiaddr+peerid）并返回multiaddr和peerid的切片。
...
//PeerSwithAddresses是一个函数，它接受一段字符串对等地址。
//（multiaddr+peerid）并返回正确构造的对等机切片
